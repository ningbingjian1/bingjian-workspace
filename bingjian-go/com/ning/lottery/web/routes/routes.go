...
import (
	...
	"bingjian-go/com/ning/lottery/bootstrap"
	"bingjian-go/com/ning/lottery/web/controllers"
	"bingjian-go/com/ning/lottery/services"
	"bingjian-go/com/ning/lottery/web/middleware"
)
